#ifndef _ROS_lidar_vision_buoy_h
#define _ROS_lidar_vision_buoy_h
...
namespace lidar_vision
{

  class buoy : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "lidar_vision/buoy"; };
    const char * getMD5(){ return "435c064753e453a41cac6f788b04bd83"; };
